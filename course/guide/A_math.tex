...
Positive numbers like $2, 10, 6$ (the $+$ sign can be omitted) and negative numbers like $-10, -2$ are called integers. These numbers can be ordered to form a coordinate system centred around $0$, as shown below:
