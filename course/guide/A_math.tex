...
\paragraph{Numbers}%
%
Positive numbers like $1, 10, 6$ (the $+$ sign can be omitted) and negative numbers like $-10, -7$ are called integers. These numbers can be ordered to form a coordinate system centred around $0$, as shown below:
...
\includegraphics[width=\linewidth]{images/math-fun_explog} \caption{Left: logarithmic vs. exponential functions. Right: natural logarithm vs. exponential functions.\label{fig:fun_explog}}
\end{figure}
