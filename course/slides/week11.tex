  ...
  % \end{frame}
	\begin{frame}[t]{The \red{truly hard part}}
		\begin{columns}[T]
			...
			Systematically interpret your results, drawing on the \red{weekly readings} for help and on \red{example papers} for examples of how to report findings.\vspace{1em}%
