...
* (2) Data
*   - Preparation
*   - Description (includes normality and association tests)
*   - Visualization
* (3) Model
*   - 
...
// shape of residuals along the age distribution
rvpplot agea, yline(0) 
...
tsst using summary.tsv, su(geq agea income edu lrscale) fr(female faith) replace // export stats

* note: tsst is a command written for this course
* use tabout from draft1.do if tsst does not work (though it should work fine)
...
// done; your final do-file can look pretty much like this one
