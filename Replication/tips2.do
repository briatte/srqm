...
* Tip (13): Summary of export commands
*
* example data
...
esttab m1 m2 m3 using models.csv, mtitles("Full model" "Education" "Theocracy") replace // export
...
* Tip (14): Looking at negative findings
*
* example data
use datasets/qog2011, clear
...
* Tip (15): Association tests for ordinal data
*
* example data
...
* Tip (16): Categorical associations
*
...
* visualize: the spine/mosaic plot is probably your best shot
...
* Tip (17): Comparing countries or country groups
*
* example data
use datasets/ess2008, clear
...
* Tip (18): Comparing at the supranational level
*
* example data
use datasets/qog2011, clear
...
* Tip (19): Using nested regression analysis
*
* example data
use datasets/qog2011, clear
...
* Tip (20): Plotting clean regression graphs
*
* example data
use datasets/qog2011, clear
gen wdi_gdpc_log=ln(wdi_gdpc)

* clean graph schemes (uncomment to run)
